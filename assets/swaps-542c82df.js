import{i as C,b as U,h as A,N as D,x as u,d as K,j as W,R as S,A as j,f as V,M,W as F,r as Q,k as q}from"./index-b83e453d.js";import{r as a,n as g,c as E,U as m}from"./if-defined-97214a5d.js";import"./index-fab20c62.js";import{M as R}from"./index-d8a5fef9.js";import"./index-acb51d9a.js";import{S as n}from"./index-b969fcb8.js";import"./index-711a83c8.js";import"./index-b615e7bb.js";import"./index-6d8ca88d.js";import"./index-dc10b23f.js";import"./index-34a7d1d2.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
